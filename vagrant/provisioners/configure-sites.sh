   ...
   util.resetColdFusionServerXML()
	...
	for( siteConfigPath in siteConfigPaths ) {
		...
		try {
         ...
         // Process ColdFusion Context (webroots)
         util.appendWebRootToColdFusionServerXML( config, siteConfigPath )
